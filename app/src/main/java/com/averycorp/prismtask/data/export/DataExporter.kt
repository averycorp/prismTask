...
constructor(
    ...
    suspend fun exportToJson(options: ExportOptions): String {
        ...
        dashboard.addProperty("ringAsCompletionArc", dashboardPreferences.getRingAsCompletionArc().first())
    ...
    private suspend fun exportNotificationConfig(): JsonObject = JsonObject().apply {
        ...
        addProperty("taskRemindersFollowSystem", p.taskRemindersFollowSystem.first())
        addProperty("taskRemindersVolumeLoud", p.taskRemindersVolumeLoud.first())
        addProperty("taskRemindersVibrationRepeat", p.taskRemindersVibrationRepeat.first())
        addProperty("timerAlertsFollowSystem", p.timerAlertsFollowSystem.first())
        addProperty("timerAlertsVolumeLoud", p.timerAlertsVolumeLoud.first())
        addProperty("timerAlertsVibrationRepeat", p.timerAlertsVibrationRepeat.first())
        addProperty("medicationRemindersFollowSystem", p.medicationRemindersFollowSystem.first())
        addProperty("medicationRemindersVolumeLoud", p.medicationRemindersVolumeLoud.first())
        addProperty("medicationRemindersVibrationRepeat", p.medicationRemindersVibrationRepeat.first())
