...
object SyncMapper {
    fun taskToMap(
        ...
        "lastEngagementAt" to task.lastEngagementAt,
        "reEntryContext" to task.reEntryContext,
        "dormancyThresholdDaysOverride" to task.dormancyThresholdDaysOverride,
    ...
    fun mapToTask(
        ...
        lastEngagementAt = (data["lastEngagementAt"] as? Number)?.toLong(),
        reEntryContext = data["reEntryContext"] as? String,
        dormancyThresholdDaysOverride = (data["dormancyThresholdDaysOverride"] as? Number)?.toInt(),
    ...
    fun habitToMap(habit: HabitEntity): Map<String, Any?> = mapOf(
        ...
        "streakMaxMissedDays" to habit.streakMaxMissedDays,
        "forgivenessEnabled" to habit.forgivenessEnabled,
        "forgivenessAllowedMisses" to habit.forgivenessAllowedMisses,
        "forgivenessGracePeriodDays" to habit.forgivenessGracePeriodDays,
    ...
    fun mapToHabit(
        ...
        return HabitEntity(
            ...
            streakMaxMissedDays = (data["streakMaxMissedDays"] as? Number)?.toInt() ?: -1,
            forgivenessEnabled = (data["forgivenessEnabled"] as? Number)?.toInt() ?: -1,
            forgivenessAllowedMisses = (data["forgivenessAllowedMisses"] as? Number)?.toInt() ?: -1,
            forgivenessGracePeriodDays = (data["forgivenessGracePeriodDays"] as? Number)?.toInt() ?: -1,
            isBuiltIn = isBuiltIn,
