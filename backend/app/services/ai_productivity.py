...
- If the text contains source code or data structures (like .jsx, .json, arrays), look for and extract ALL embedded schedules, syllabi, reading lists, or assignments. Also extract ALL TODOs, FIXMEs, BUG notes, and refactoring comments.
